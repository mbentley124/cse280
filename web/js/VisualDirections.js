...
class VisualDirections {
     ...
     */
    _makeStartingRequest(serverURL = "https://public-routing-proxy.triplemap.me/route/v1/foot/") {
        if(this.sameStart) {
     ...
     * @param {string} serverURL 
     */
    _makeEndingRequest(serverURL = "https://public-routing-proxy.triplemap.me/route/v1/foot/") {
        if(this.sameEnd) {
